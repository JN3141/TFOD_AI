...
// Fills the trail array with the location ids of the last 6 turns
//   for Dracula but instead of getting precise information
//   about where he has been (real locations, not double-back, etc),
//   he gets all the TP's and HI's etc.
void giveMeTheFakeTrail(DracView currentView, LocationID fakeTrail[TRAIL_SIZE]);
